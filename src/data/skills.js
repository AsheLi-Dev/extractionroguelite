...
export const SKILL_DEFS = [
  ...
  { id: "knight_slide", name: "Stone Wall", icon: "spr_skill_bladeDash", illustration: "assets/UI/Blade Dash.png", baseCd: 7, desc: "Create a stone wall in front that slows nearby units by 80%. Friendly projectiles and melee attacks ignore it.", unlock: "always", category: "melee", tags: ["melee", "utility", "crowd_control"], heroOnly: true, scalingPrimary: "B", scalingStat1: "brutality", scalingSecondary: "B", scalingStat2: "agility" },
  ...
  { id: "dark_mage_blood_refresh", name: "Blood Refresh", icon: "spr_skill_voidRift", illustration: "assets/UI/Void Rift.png", baseCd: 10, desc: "Lose 10 HP and fully refresh the cooldown of another random skill that is currently on cooldown.", unlock: "always", category: "projectile", tags: ["utility"], heroOnly: true, scalingPrimary: "C", scalingStat1: "vitality", scalingSecondary: "B", scalingStat2: "luck" },
  { id: "wind_archer_retreat_volley", name: "Retreat Volley", icon: "spr_skill_rapidFire", illustration: "assets/UI/Rapid Fire.png", baseCd: 12, desc: "Leap backward and fire a slowing 5-arrow volley. If a dash charge is available, consume 1 for an empowered cast. Kills restore 1 dash charge once per cast.", unlock: "always", category: "projectile", tags: ["projectile", "ranged", "crowd_control", "utility"], heroOnly: true, scalingPrimary: "B", scalingStat1: "agility", scalingSecondary: "B", scalingStat2: "brutality" },
  { id: "element_mage_spell_art", name: "Spell Art", icon: "spr_skill_iceShard", illustration: "assets/UI/Ice Shard.png", baseCd: 6, desc: "Rotation: Fire Breath, Wind Blow, Fire Breath, Lightning Splash.", unlock: "always", category: "projectile", tags: ["projectile", "area", "crowd_control"], heroOnly: true, scalingPrimary: "B", scalingStat1: "agility", scalingSecondary: "B", scalingStat2: "brutality" },
  { id: "death_knight_summon_lich", name: "Summon Lich", icon: "spr_skill_voidRift", illustration: "assets/UI/Void Rift.png", baseCd: 10, desc: "Summon a Lich for 10s. After it expires, the skill goes on cooldown for 10s.", unlock: "always", category: "projectile", tags: ["summon", "utility", "crowd_control"], heroOnly: true, scalingPrimary: "B", scalingStat1: "brutality", scalingSecondary: "C", scalingStat2: "vitality" }
];
