...
let rockBorderImage = null;

function getRockBorderImage() {
  if (rockBorderImage) return rockBorderImage;
  rockBorderImage = new Image();
  rockBorderImage.src = assetUrl(ROCK_BORDER_IMAGE_SRC);
  return rockBorderImage;
}
